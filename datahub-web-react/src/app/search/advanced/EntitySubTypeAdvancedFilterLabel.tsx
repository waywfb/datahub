        ...
        <FilterContainer isCompact={isCompact} isDisabled>
            <FilterWrapper>
                    ...
                    <>
                        ...
                        <FilterValuesWrapper>
                            {entityTypes?.map((entityType, index) => (
                                <>
                                    {entityRegistry.getCollectionNameTrans(entityType as EntityType, t)}
                ...
                {Object.entries(entityTypeToSubTypes).map(([entityType, subTypes]) => (
                    <>
                        <FilterFieldLabel>{t('common.type')}</FilterFieldLabel>
                        <ConditionWrapper>{t('filter.is.true')}</ConditionWrapper>
                        <FilterValuesWrapper>
                            {entityRegistry.getCollectionNameTrans(entityType as EntityType, t)}
                        </FilterValuesWrapper>
                        <FilterFieldLabel>{t('common.subtype')}</FilterFieldLabel>
                        <ConditionWrapper>{t('filter.isOf.true')}</ConditionWrapper>
                        <FilterValuesWrapper>
