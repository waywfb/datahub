        ...
        >
            ...
            {postType === PostContentType.Text && (
                <TopFormItem label={<Typography.Text strong>{t('common.description')}</Typography.Text>}>
                    ...
                    <SubFormItem name={DESCRIPTION_FIELD_NAME} rules={[{ min: 0, max: 500 }]} hasFeedback>
                        <Input.TextArea placeholder={t('post.descriptionPlaceholder')} />
                    </SubFormItem>
                </TopFormItem>
            )}
            {postType === PostContentType.Link && (
                <>
                    ...
                    <SubFormItem label={<Typography.Text strong>{t('')}</Typography.Text>}>
                        ...
                        <SubFormItem
                            ...
                            hasFeedback
                        >
                            <Input data-testid="create-post-media-location" placeholder={t('imageUrlPlaceholder')} />
                        </SubFormItem>
                    </SubFormItem>
                </>
            )}
